...

{
  ...
  "prompt_call": {
    "prompt_id": "TEXT_TO_VIDEO_PROMPT_REWRITER",
...
- provenance.rewriter_id 固定为 TEXT_TO_VIDEO_PROMPT_REWRITER，rewriter_version 固定为 3.1.0，source 固定为 llm；template_refs 仅放 Runtime 实际注入的内部 pattern ID。
