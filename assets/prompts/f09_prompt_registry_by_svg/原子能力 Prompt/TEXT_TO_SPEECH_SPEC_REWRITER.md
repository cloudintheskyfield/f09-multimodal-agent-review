...

{
  ...
  "prompt_call": {
    "prompt_id": "TEXT_TO_SPEECH_SPEC_REWRITER",
...

{
  ...
  "provenance": {
    "rewriter_id": "TEXT_TO_SPEECH_SPEC_REWRITER",
...
- provenance.rewriter_id 固定为 TEXT_TO_SPEECH_SPEC_REWRITER，rewriter_version 固定为 2.1.0，source 固定为 llm；template_refs 仅放 Runtime 实际注入的内部 pattern ID。
