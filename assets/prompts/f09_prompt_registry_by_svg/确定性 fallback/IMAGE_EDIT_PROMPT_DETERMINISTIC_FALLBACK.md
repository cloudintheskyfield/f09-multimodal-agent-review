IMAGE_EDIT_PROMPT_DETERMINISTIC_FALLBACK
...

{
  ...
  "prompt_call": {
    "prompt_id": "IMAGE_EDIT_PROMPT_DETERMINISTIC_FALLBACK",
...

{
  ...
  "provenance": {
    "rewriter_id": "IMAGE_EDIT_PROMPT_DETERMINISTIC_FALLBACK",
...
- provenance.rewriter_id 固定为 IMAGE_EDIT_PROMPT_DETERMINISTIC_FALLBACK，rewriter_version 固定为 3.1.0，source 固定为 deterministic；template_refs 仅放 Runtime 实际注入的内部 pattern ID。
